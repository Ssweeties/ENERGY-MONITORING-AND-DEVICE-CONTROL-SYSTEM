...
*   **`dev1/`** & **`dev2/`**: Stores electrical values (`U`, `I`, `P`, `E`) and Relay `Status` (bool).
*   **`User/`**: Tracks cumulative energy usage per user (`E`, `E1`, `E2`).
*   **`login`, `logout`**: System state flags (bool).
...
## Functional Diagram
<p align="center">
  <img src="https://github.com/Ssweeties/ENERGY-MONITORING-AND-DEVICE-CONTROL-SYSTEM/blob/d3222e08c455b0b7b3be6c2ac91a05b1994e28e5/img/Diagram.png?raw=true" alt="Diagram" width="37%">
</p>
